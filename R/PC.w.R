...
## recode
# This is a mandatory argument. Can be 1 or 2. recode = 1 aggregates "Almost every month" and 
...
mrpcm_out=list("country"=runtitle,"b"=i_df_rtparam,
               "n.compl"=nccnext,"nit"=niterate,
               "lastadj"=maxadj,"se.b"=i_df_error,"infit"=i_df_rtinfit,
